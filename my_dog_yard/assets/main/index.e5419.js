window.__require = function e(t, n, r) {
  ...
  BoosterController: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      init: function init(opts) {
        ...
        this.lockedUserInteraction = false;
        this.container = this.node.getChildByName("container");
        var firstPositionX = ITEM_FIRST_POSITION[0] - (_userState["default"].getSelectedBoosterCount() + Object.keys(this.temporaryBoosters).length - 1) * (ITEM_SPACING + ITEM_SIZE) * .5;
        var i = 0;
      ...
      exitBoosterMode: function exitBoosterMode(isBoosterActivated, type, isTemporary) {
        ...
        this.isActive = false;
        var items = isTemporary ? this.tempItems : this.items;
        this.selectingType && (items[this.selectingType].node.zIndex = 0);
        this.selectingType && items[this.selectingType].setSelected(false);
        this.selectingType = null;
        this.overlay.active = false;
  ...
  CatItem: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      loadItem: function loadItem(cat) {
        ...
        nameLabel.color = unlocked ? this.normalColor : this.lockedColor;
  ...
  CatSubscene: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      updateScreenSize: function updateScreenSize(frame, uiScale) {
        ...
        var popup = this.node.getChildByName("popup");
        popup.scale = Math.min(uiScale / .92, 1);
      }
    });
    cc._RF.pop();
  }, {
  ...
  Game: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        this.catBoardAttachment.relativeX = this.catBoardAttachment.x + this.catSpine.node.x;
      ...
      animateChangingTurnLabel: function animateChangingTurnLabel() {
        ...
        cc.tween(this.turnNumLabel.node).to(.3, {
          ...
          _this3.turnNumLabel.string = _this3.turns;
        }).delay(.05).to(.2, {
          scale: 1
        }, {
          easing: "linear"
      ...
      onStartSelectionClosed: function onStartSelectionClosed() {
        ...
        var oldTurns = this.turns;
        this.triggerCatStartingAbilities();
        oldTurns !== this.turns && this.animateChangingTurnLabel();
        this.app.IS_DEVELOPMENT && globalThis.app.enableX3Turn && (this.turns *= 3);
        ...
        cc.tween(this.catSpine.node).by(.8, {
          ...
          progress: function progress(start, end, current, ratio) {
            ...
            _this4.catBoardAttachment.x = _this4.catBoardAttachment.relativeX - value;
            _this4.catBoardAttachment.updateOffset();
            return value;
          }
        }).start();
        ...
        setTimeout(function() {
          _this4.gameBoard.unlockUserInteraction("startSelection");
          _this4.gameBoard.checkMatchesRequest = true;
          _this4.tutorialController.triggerTutorial();
        }, 400);
      },
  ...
  QAPanel: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      loadX3TurnSetting: function loadX3TurnSetting() {
        this.propertyLines["x3Turn"].toggle.isChecked = !!globalThis.app.enableX3Turn;
      },
      ...
      onPropertyToggle: function onPropertyToggle(event) {
        ...
        "x3Turn" === type && (globalThis.app.enableX3Turn = event.isChecked);
      },
      ...
      onResetClicked: function onResetClicked(event) {
        ...
        catSubscene && catSubscene.node.active ? catSubscene.refreshCatItems() : this.app.catRefreshRequest = true;
        var bagSubscene = this.subsceneController.subsceneMap["bag"].object;
        if (bagSubscene && bagSubscene.node.active) {
          bagSubscene.loadSupplyItems();
          bagSubscene.loadBoosterItems();
        } else {
          this.app.boostersRefreshRequest = true;
          this.app.suppliesRefreshRequest = true;
        }
  ...
  ShopCommands: [ function(require, module, exports) {
    ...
    function buy(itemId, number) {
      ...
      switch (itemId) {
       case "fish":
        _userState["default"].updateFish(1 * number);
        break;

       case "fish5":
        _userState["default"].updateFish(5 * number);
        break;

       case "fish10":
        _userState["default"].updateFish(10 * number);
        break;
  ...
  YardItem: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      setConfig: function setConfig(config) {
        ...
        this.bubble.x = this.config.catOffset.x + 54;
          ...
          data: {
            ...
            resolve: function resolve(data) {
              if ("jamCabinet" === that.cabinetData.mainType || "milkCabinet" === that.cabinetData.mainType) {
                ...
                _child.layers[_child.currentLayerId].x = _child.layers[_child.currentLayerId].initialX;
                _child.layers[_child.currentLayerId].y = _child.layers[_child.currentLayerId].initialY;
              }
          ...
          update: function update(dt, data) {
            ...
            if (that.layers[that.currentLayerId]) {
              if ("jamCabinet" === that.cabinetData.mainType || "milkCabinet" === that.cabinetData.mainType) {
                ...
                _child2.layers[_child2.currentLayerId].x = _child2.layers[_child2.currentLayerId].initialX + dx;
                _child2.layers[_child2.currentLayerId].y = _child2.layers[_child2.currentLayerId].initialY + dy;
              }
  ...
  catModels: [ function(require, module, exports) {
    ...
    var Cat = function() {
      ...
      _proto.getCurrentSkillDesc = function getCurrentSkillDesc() {
        return this.config.skillDescs[this.getIntimacyLevel()] || "Not yet unlocked";
      };
      return Cat;
    }();
    var _default = {
  ...
  cats: [ function(require, module, exports) {
    ...
    var _default = {
      bella: {
        ...
        skillDescs: {
          1: "Increase the 1 step at the beginning of the game.",
          2: "Increase the 2 step at the beginning of the game.",
          3: "Increase the 3 step at the beginning of the game."
        }
      },
      milo: {
        name: "Milo",
        ...
        skillDescs: {
          1: "Set 1 Frisbee at the start of the game in a random position.",
          2: "Set 2 Frisbees at the start of the game in a random position.",
          3: "Set 3 Frisbees at the start of the game in a random position."
        }
      },
      dora: {
        name: "Dora",
        ...
        skillDescs: {
          1: "Set 1 Rocket at the start of the game in a random position.",
          2: "Set 2 Rockets at the start of the game in a random position.",
          3: "Set 3 Rockets at the start of the game in a random position."
        }
      },
      lily: {
        name: "Lily",
        ...
        skillDescs: {
          1: "Set 1 Bomb at the start of the game in a random position.",
          2: "Set 2 Bombs at the start of the game in a random position.",
          3: "Set 3 Bombs at the start of the game in a random position."
        }
      },
      leo: {
        name: "Leo",
        ...
        skillDescs: {
          1: "Temporary add 1 Hammer at the beginning of the game.",
          2: "Temporary add 2 Hammers at the beginning of the game.",
          3: "Temporary add 3 Hammers at the beginning of the game."
        }
      },
      max: {
        name: "Max",
        ...
        skillDescs: {
          1: "Temporary add 1 Wheel at the beginning of the game.",
          2: "Temporary add 2 Wheels at the beginning of the game.",
          3: "Temporary add 3 Wheels at the beginning of the game."
        }
      },
      luna: {
        name: "Luna",
        ...
        skillDescs: {
          1: "Get 2 extra steps when the player loses the game",
          2: "Get 4 extra steps when the player loses the game",
          3: "Get 6 extra steps when the player loses the game"
        }
      },
      bob: {
        name: "Bob",
        ...
        skillDescs: {
          1: "Set 1 sunflower at the start of the game in a random position.",
          2: "Set 2 sunflowers at the start of the game in a random position.",
          3: "Set 3 sunflowers at the start of the game in a random position."
        }
      }
    };
    exports["default"] = _default;
  ...
  development: [ function(require, module, exports) {
    ...
    var levels = {
      ...
      d999990: {
        ...
        turns: 999,
        spawnPattern: [ A, A, A, A, A, A, A, A, A ],
        pattern: [ [ s, s, s, s, s, s, s, s, s ], [ s, s, s, s, s, s, s, s, s ], [ y, y, g, b, y, b, g, y, g ], [ r, N, N, r, b, g, Q, Q, r ], [ y, N, N, b, y, y, Q, Q, g ], [ b, L, P, y, g, y, L, L, b ], [ b, L, P, y, g, b, P, P, b ], [ g, N, Q, b, x, g, S, S, y ], [ g, P, L, b, r, g, S, S, y ] ]
      }
    };
    var _default = levels;
    exports["default"] = _default;
  ...
  main: [ function(require, module, exports) {
    ...
    var levels = {
      ...
      9: {
        ...
        turns: 25,
        spawnPattern: [ U, U, U, U, U, U, U, U, U ],
        pattern: [ [ O, O, t, t, O, t, t, O, O ], [ t, t, t, t, O, t, t, t, t ], [ t, t, t, t, O, t, t, t, t ], [ t, t, t, t, O, t, t, t, t ], [ O, O, O, O, O, O, O, O, O ], [ r, b, y, y, r, p, p, b, p ], [ r, r, p, y, y, p, b, p, b ], [ y, p, r, p, p, r, b, r, y ], [ p, b, p, y, y, b, p, p, y ] ],
      ...
      10: {
        ...
        turns: 22,
        spawnPattern: [ U, U, U, U, U, U, U, U, U ],
        pattern: [ [ t, t, t, O, O, O, t, t, t ], [ t, x, x, p, p, r, x, x, t ], [ t, x, x, y, p, p, x, x, t ], [ t, x, x, b, r, p, x, x, t ], [ t, x, x, r, p, b, x, x, t ], [ t, x, x, y, y, p, x, x, t ], [ t, x, x, b, r, y, x, x, t ], [ t, x, x, b, r, r, x, x, t ], [ t, t, t, O, O, O, t, t, t ] ],
      ...
      16: {
        ...
        turns: 36,
        spawnPattern: [ U, U, U, U, U, U, U, U, U ],
        pattern: [ [ y, y, r, y, p, b, b, r, b ], [ p, b, p, p, y, r, p, y, r ], [ x, x, x, x, x, x, x, x, x ], [ H, H, H, H, x, H, H, H, H ], [ H, H, H, H, x, H, H, H, H ], [ O, O, O, O, O, O, O, O, O ], [ x, x, x, x, G, x, x, x, x ], [ x, x, x, x, G, x, x, x, x ], [ x, x, x, x, G, x, x, x, x ] ],
      ...
      19: {
        ...
        turns: 28,
        spawnPattern: [ U, U, U, U, U, U, U, U, U ],
        pattern: [ [ G, x, x, x, x, b, y, y, w ], [ G, x, x, x, x, r, b, y, w ], [ G, x, x, x, x, p, b, r, w ], [ G, x, x, x, x, b, p, y, w ], [ O, O, O, O, O, p, r, p, w ], [ G, x, x, x, x, p, y, r, w ], [ G, x, x, x, x, r, b, r, w ], [ G, x, x, x, x, r, b, b, w ], [ G, x, x, x, x, y, r, b, w ] ],
      ...
      25: {
        ...
        turns: 24,
        spawnPattern: [ U, U, U, U, U, U, U, U, U ],
        pattern: [ [ r, y, p, p, r, t, r, p, r ], [ r, p, y, y, b, b, y, b, p ], [ t, t, t, t, t, t, t, t, t ], [ t, t, t, t, t, t, t, t, t ], [ w, t, t, t, t, t, t, t, w ], [ w, w, t, t, t, t, t, w, w ], [ w, w, w, t, t, t, w, w, w ], [ w, w, w, w, t, w, w, w, w ], [ G, G, G, G, G, G, G, G, G ] ],
      ...
      28: {
        ...
        turns: 24,
        spawnPattern: [ U, U, U, U, U, U, U, U, U ],
        pattern: [ [ w, r, y, y, p, y, r, p, w ], [ w, H, H, t, t, t, H, H, w ], [ w, H, H, t, t, t, H, H, w ], [ w, r, p, t, t, t, y, p, w ], [ w, b, b, t, t, t, p, y, w ], [ w, p, b, t, t, t, y, y, w ], [ w, H, H, t, t, t, H, H, w ], [ w, H, H, t, t, t, H, H, w ], [ w, r, y, r, b, r, r, p, w ] ],
